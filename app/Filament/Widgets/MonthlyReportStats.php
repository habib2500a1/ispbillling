...
class MonthlyReportStats extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        return [
            Stat::make('Invoiced (this month)', $this->formatMoney($invoiced).' BDT')
                ->description('Sum of invoice totals by issue date'),
            Stat::make('Collected (this month)', $this->formatMoney($collected).' BDT')
                ->description('Completed payments by paid date'),
            Stat::make('Outstanding AR', $this->formatMoney($arDue).' BDT')
