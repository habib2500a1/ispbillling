...
class AdminModuleRegistry
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['group' => 'Billing', 'section' => 'Collections', 'label' => 'Staff performance', 'description' => 'Collection & new lines by staff', 'url' => \App\Filament\Pages\StaffPerformanceReport::getUrl(), 'accent' => 'text-sky-600', 'icon' => 'heroicon-o-user-group'],
            ...
            ['group' => 'System', 'section' => 'Integrations', 'label' => 'Performance', 'description' => 'Polling · subscriber speed · CSS cache', 'url' => \App\Filament\Pages\ManagePerformanceSettings::getUrl(), 'accent' => 'text-emerald-600', 'icon' => 'heroicon-o-bolt'],
            ['group' => 'System', 'section' => 'Integrations', 'label' => 'Customer search', 'description' => 'Meilisearch · ticket & bill lookup', 'url' => \App\Filament\Pages\ManageCustomerSearchSettings::getUrl(), 'accent' => 'text-sky-600', 'icon' => 'heroicon-o-magnifying-glass-circle'],
