    ...
    public static function definitions(): array
    {
        ...
        return [
            ...
            [
                ...
                'active_routes' => ['filament.admin.resources.subscribers.due'],
                'badge_key' => 'due_clients',
            ],
            [
                'key' => 'vip',
                'label' => 'VIP clients',
                ...
                'active_routes' => ['filament.admin.resources.subscribers.vip'],
                'badge_key' => 'vip',
            ],
            [
                'key' => 'free',
                ...
                'active_routes' => ['filament.admin.resources.subscribers.free'],
                'badge_key' => 'free',
            ],
            [
                'key' => 'today',
            ...
            [
                ...
                'icon' => 'heroicon-o-clock',
                'sort' => 8.5,
                'url' => CustomerResource::getUrl('expire-7'),
                'active_routes' => ['filament.admin.resources.subscribers.expire-7'],
            ],
            [
                'key' => 'expired',
