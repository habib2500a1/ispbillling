...
final class FeatureModuleRegistry
{
    ...
    private static function billing(): array
    {
        return [
            ...
            ['slug' => 'discount-list', 'group' => 'Billing', 'section' => 'Collections', 'label' => 'Discount list', 'description' => 'Customers with bill discount', 'icon' => 'bi-percent', 'accent' => 'warning', 'route' => 'billing.discounts'],
            ['slug' => 'advance-list', 'group' => 'Billing', 'section' => 'Collections', 'label' => 'Advance list', 'description' => 'Customers with bill advance', 'icon' => 'bi-wallet2', 'accent' => 'info', 'route' => 'billing.advances'],
