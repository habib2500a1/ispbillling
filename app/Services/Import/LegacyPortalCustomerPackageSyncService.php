...
final class LegacyPortalCustomerPackageSyncService
{
     ...
     */
    public function syncAll(LegacyPortalSessionClient $client, string $query = 'alloverclients'): array
    {
        $client->login();
     ...
     */
    public function syncCustomersByIds(LegacyPortalSessionClient $client, array $customerIds): array
    {
        $client->login();
