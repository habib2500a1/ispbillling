    ...
    private function defaultRows(): array
    {
        return [
            ...
            [
                ...
                'name' => 'Legacy portal ONU sync (OLT → link → dBm)',
                'description' => 'BDCOM SNMP inventory, PPP login match, optical power — same flow as the online billing portal.',
                'artisan_command' => 'isp:legacy-portal-onu-sync',
                'command_options' => [],
                'execute_at' => '00:00',
                'interval' => 'every_three_minutes',
                'when_config_key' => 'optical.legacy_portal_auto_sync',
