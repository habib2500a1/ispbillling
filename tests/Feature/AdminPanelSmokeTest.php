...
class AdminPanelSmokeTest extends TestCase
{
    ...
    {
        return [
            'dashboard' => ['/admin', 'fi-dashboard-page'],
            ...
            'optical noc' => ['/admin/optical-noc', 'Optical Database'],
            ...
            'customers' => ['/admin/subscribers', 'Subscriber'],
            ...
            'staff hub' => ['/admin/staff-control-hub', 'staff control'],
            'permission matrix' => ['/admin/permission-matrix', 'Permission matrix'],
            'network intelligence hub' => ['/admin/network-intelligence-hub', 'Network center'],
