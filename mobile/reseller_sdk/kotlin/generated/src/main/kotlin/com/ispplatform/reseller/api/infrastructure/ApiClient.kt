package com.ispplatform.reseller.api.infrastructure

import com.ispplatform.reseller.api.auth.HttpBearerAuth
import com.ispplatform.reseller.api.auth.HttpBearerAuth
import com.ispplatform.reseller.api.auth.ApiKeyAuth
...
class ApiClient(
    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth: Interceptor? = when (authName) { 
                "sanctumBearer" -> HttpBearerAuth("bearer")
                
                "apiKeyBearer" -> HttpBearerAuth("bearer")
                
                "apiKeyHeader" -> ApiKeyAuth("header", "X-Reseller-Api-Key")
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey: String = "com.ispplatform.reseller.api.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://your-domain.example/api/v1")
        }
    }
}
