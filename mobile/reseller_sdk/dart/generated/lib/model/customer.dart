...
class Customer {
  ...
  bool operator ==(Object other) => identical(this, other) || other is Customer &&
    ...
    _deepEquality.equals(other.package, package);
  ...
  @override
  String toString() => 'Customer[id=$id, name=$name, customerCode=$customerCode, phone=$phone, status=$status, packageId=$packageId, package=$package]';
  ...
  static Customer? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Customer(
        ...
        package: mapCastOfType<String, Object>(json, r'package') ?? const {},
      );
    }
    return null;
  }
