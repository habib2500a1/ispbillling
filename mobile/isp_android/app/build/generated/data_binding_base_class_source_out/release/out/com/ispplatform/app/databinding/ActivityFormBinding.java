...
public final class ActivityFormBinding implements ViewBinding {
  ...
  private ActivityFormBinding(@NonNull ScrollView rootView, @NonNull LinearLayout formContainer) {
  ...
  public static ActivityFormBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFormBinding((ScrollView) rootView, formContainer);
    }
