<div
    x-data="{
        open: false,
        q: '',
        items: <?php echo \Illuminate\Support\Js::from($commandItems ?? [])->toHtml() ?>,
        entityResults: [],
        searching: false,
        searchError: '',
        searchUrl: <?php echo \Illuminate\Support\Js::from(route('admin.smart-search'))->toHtml() ?>,
        get filtered() {
...
<?php /**PATH /var/www/isp-platform/resources/views/filament/hooks/command-palette.blade.php ENDPATH**/ ?>