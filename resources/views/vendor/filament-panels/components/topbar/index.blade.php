...
<div
    {{
        $attributes->class([
            'fi-topbar sticky top-0 z-20 overflow-x-clip lg:overflow-visible',
            'fi-topbar-with-navigation' => filament()->hasTopNavigation(),
        ])
    }}
>
    <nav
        class="flex h-16 items-center gap-x-4 overflow-x-clip bg-white px-4 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 md:px-6 lg:overflow-visible lg:px-8"
    >
        ...
        {{-- No x-persist: Livewire persist duplicated topbar.end and broke PC profile dropdown --}}
        <div class="fi-topbar-end ms-auto flex shrink-0 items-center gap-x-4">
