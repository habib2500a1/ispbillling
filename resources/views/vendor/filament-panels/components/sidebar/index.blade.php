...
>
    <div class="overflow-x-clip">
        ...
        >
            <div class="isp-sidebar-header__brand">
                <div
                    class="isp-sidebar-header__logo"
                ...
                @if (filament()->isSidebarCollapsibleOnDesktop())
                    <div
                        class="isp-sidebar-header__badge hidden lg:flex"
                        x-cloak
                        x-show="! $store.sidebar.isOpen"
                    >
                        @if ($homeUrl = filament()->getHomeUrl())
                            <a {{ \Filament\Support\generate_href_html($homeUrl) }}>
                                @include('filament.hooks.sidebar-brand-badge')
                            </a>
                        @else
                            @include('filament.hooks.sidebar-brand-badge')
                        @endif
    ...
    >
        ...
        <script data-cfasync="false">
            var NON_COLLAPSIBLE_GROUPS = ['Overview']
            ...
            if (Array.isArray(collapsedGroups)) {
                collapsedGroups = collapsedGroups.filter(
                    (label) => !NON_COLLAPSIBLE_GROUPS.includes(label),
                )
            ...
            document
                ...
                .forEach((group) => {
                    ...
                    if (!collapsedGroups.includes(label)) {
                        return
                    }
