<div>
    {{-- No Falcon page-title card — console has its own header. --}}
    ...
    <style>
        ...
        .os-shell .os-kicker { font-size:.68rem; letter-spacing:.12em; text-transform:uppercase; font-weight:800; color:#64748b; margin-bottom:.2rem; }
        ...
        .os-shell .os-chip.ok { background:#eef4fb; color:#1e3a5f; border-color:#d7e3f0; }
        ...
        .os-shell .os-quick a:hover { border-color:#94a3b8; background:#f8fafc; color:var(--os-ink); }
        .os-shell .os-quick a i { color:#475569; }
        ...
        .os-shell .os-ico { width:36px; height:36px; border-radius:10px; display:flex; align-items:center; justify-content:center; flex-shrink:0; background:#eef4fb; color:#1e3a5f; }
    ...
    <div class="os-shell" data-os-rev="20260831f">
        <div class="os-hero">
            <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
                ...
                <div class="os-meta">
                    ...
                    <span class="os-chip ok"><span style="width:7px;height:7px;border-radius:50%;background:#1e3a5f;display:inline-block;"></span> {{ __('Database') }}</span>
