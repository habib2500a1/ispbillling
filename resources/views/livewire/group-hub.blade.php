<div>
    ...
    <style>
        ...
        .os-shell .os-ico { width:36px; height:36px; border-radius:10px; display:flex; align-items:center; justify-content:center; background:rgba(6,173,115,.1); color:var(--os-brand-dark); }
