...
echo "  $LATEST_PUBLIC  → unzip in /home/user/ (public_html + isp-app)"
echo "  $LATEST_FULL    → unzip in /home/user/, docroot = isp-platform/public"
echo ""
echo "Then open: https://your-domain.com/install"
