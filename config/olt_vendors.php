...
return [
    ...
    'vendors' => [
        ...
        'aveis' => [
            'label' => 'Aveis',
            'support' => 'partial',
            'snmp' => ['IF-MIB', 'AVEIS enterprise 50224 (AV-OLT-XE08)'],
            'cli' => ['Web UI :8506', 'show onu', 'show pon'],
            'notes' => 'AV-OLT-XE08-L3: SNMP community public (default). OLT type = Aveis GPON. 191+ ONUs via isp:sync-aveis-gpon-onus.',
        ],
        'ecom' => [
            'label' => 'Ecom',
            'support' => 'partial',
            'snmp' => ['IF-MIB', 'VSOL-compatible MIB (set VSOL_SNMP_* OIDs)'],
            'cli' => ['show onu', 'show interface gpon'],
            'notes' => 'Ecom rebrands: often VSOL/ZTE SNMP — set env OIDs after snmpwalk or use generic_snmp + meta import.',
        ],
        'vsol' => [
            'label' => 'VSOL',
            'support' => 'partial',
